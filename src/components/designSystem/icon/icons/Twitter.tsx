...
export function Twitter({
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 20.004 20" className={className}>
